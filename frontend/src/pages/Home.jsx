          ...
          <div className="container hero-split">
            ...
            <div className="hero-left">
              <div className="hero-icons" aria-hidden="true">
                {[
                  { delay:'0s',    label:'Meta Ads',   link:'/services?service=smm',           icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 15v-4H7l5-8v4h4l-5 8z" fill="#1877F2"/></svg> },
                  { delay:'0.1s',  label:'Google',     link:'/services?service=google-ads',    icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg> },
                  { delay:'0.2s',  label:'Shopify',    link:'/services?service=shopify',       icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M15.337 23.979l6.163-1.337-2.242-15.168c-.018-.114-.114-.194-.211-.194s-2.2-.152-2.2-.152-.87-.861-1.015-1.015C15.355 5.517 14.776 2 12.053 2c-.065 0-.13.013-.194.013C11.13 1.223 10.286 1 9.567 1 4.694 1 2.38 6.807 1.673 9.695L.081 10.17 1.208 22.782 15.337 23.98v-.001z" fill="#95BF47"/></svg> },
                  { delay:'0.3s',  label:'WhatsApp',   link:'/services?service=360',           icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347M12 2C6.48 2 2 6.48 2 12a9.86 9.86 0 001.51 5.26l-.998 3.648 3.741-.982A9.87 9.87 0 0012 22c5.52 0 10-4.48 10-10S17.52 2 12 2z" fill="#25D366"/></svg> },
                  { delay:'0.4s',  label:'Analytics',  link:'/services?service=google-ads',    icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><rect x="2" y="13" width="4" height="9" rx="1" fill="#15D8E1"/><rect x="8" y="8" width="4" height="14" rx="1" fill="#15D8E1" opacity="0.7"/><rect x="14" y="4" width="4" height="18" rx="1" fill="#15D8E1" opacity="0.5"/><rect x="20" y="10" width="2" height="12" rx="1" fill="#15D8E1" opacity="0.3"/></svg> },
                  { delay:'0.5s',  label:'Web Dev',    link:'/services?service=website-design', icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M8 9l-3 3 3 3M16 9l3 3-3 3M13 6l-2 12" stroke="#6366F1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg> },
                  { delay:'0.6s',  label:'Automation', link:'/services?service=automation',    icon:<svg width="22" height="22" viewBox="0 0 24 24" fill="none"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4M4.93 19.07l2.83-2.83M16.24 7.76l2.83-2.83" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round"/><circle cx="12" cy="12" r="3" fill="#F59E0B"/></svg> },
                ].map(item => (
                  <Link key={item.label} to={item.link} className="hero-icon-wrap icon-float" style={{'--delay': item.delay}} title={item.label}>
